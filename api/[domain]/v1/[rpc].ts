...
import { createWildfireServiceRoutes } from '../../../src/generated/server/crystalball/wildfire/v1/service_server';
import { wildfireHandler } from '../../../server/crystalball/wildfire/v1/handler';
import { createClimateServiceRoutes } from '../../../src/generated/server/crystalball/climate/v1/service_server';
import { climateHandler } from '../../../server/crystalball/climate/v1/handler';
import { createPredictionServiceRoutes } from '../../../src/generated/server/crystalball/prediction/v1/service_server';
import { predictionHandler } from '../../../server/crystalball/prediction/v1/handler';
import { createDisplacementServiceRoutes } from '../../../src/generated/server/crystalball/displacement/v1/service_server';
import { displacementHandler } from '../../../server/crystalball/displacement/v1/handler';
import { createAviationServiceRoutes } from '../../../src/generated/server/crystalball/aviation/v1/service_server';
import { aviationHandler } from '../../../server/crystalball/aviation/v1/handler';
import { createResearchServiceRoutes } from '../../../src/generated/server/crystalball/research/v1/service_server';
import { researchHandler } from '../../../server/crystalball/research/v1/handler';
import { createUnrestServiceRoutes } from '../../../src/generated/server/crystalball/unrest/v1/service_server';
import { unrestHandler } from '../../../server/crystalball/unrest/v1/handler';
import { createConflictServiceRoutes } from '../../../src/generated/server/crystalball/conflict/v1/service_server';
import { conflictHandler } from '../../../server/crystalball/conflict/v1/handler';
import { createMaritimeServiceRoutes } from '../../../src/generated/server/crystalball/maritime/v1/service_server';
import { maritimeHandler } from '../../../server/crystalball/maritime/v1/handler';
import { createCyberServiceRoutes } from '../../../src/generated/server/crystalball/cyber/v1/service_server';
import { cyberHandler } from '../../../server/crystalball/cyber/v1/handler';
import { createEconomicServiceRoutes } from '../../../src/generated/server/crystalball/economic/v1/service_server';
import { economicHandler } from '../../../server/crystalball/economic/v1/handler';
import { createInfrastructureServiceRoutes } from '../../../src/generated/server/crystalball/infrastructure/v1/service_server';
import { infrastructureHandler } from '../../../server/crystalball/infrastructure/v1/handler';
import { createMarketServiceRoutes } from '../../../src/generated/server/crystalball/market/v1/service_server';
import { marketHandler } from '../../../server/crystalball/market/v1/handler';
import { createNewsServiceRoutes } from '../../../src/generated/server/crystalball/news/v1/service_server';
import { newsHandler } from '../../../server/crystalball/news/v1/handler';
import { createIntelligenceServiceRoutes } from '../../../src/generated/server/crystalball/intelligence/v1/service_server';
import { intelligenceHandler } from '../../../server/crystalball/intelligence/v1/handler';
import { createMilitaryServiceRoutes } from '../../../src/generated/server/crystalball/military/v1/service_server';
import { militaryHandler } from '../../../server/crystalball/military/v1/handler';
import { createPositiveEventsServiceRoutes } from '../../../src/generated/server/crystalball/positive_events/v1/service_server';
import { positiveEventsHandler } from '../../../server/crystalball/positive-events/v1/handler';
import { createGivingServiceRoutes } from '../../../src/generated/server/crystalball/giving/v1/service_server';
import { givingHandler } from '../../../server/crystalball/giving/v1/handler';
import { createTradeServiceRoutes } from '../../../src/generated/server/crystalball/trade/v1/service_server';
import { tradeHandler } from '../../../server/crystalball/trade/v1/handler';
import { createSupplyChainServiceRoutes } from '../../../src/generated/server/crystalball/supply_chain/v1/service_server';
import { supplyChainHandler } from '../../../server/crystalball/supply-chain/v1/handler';

import type { ServerOptions } from '../../../src/generated/server/crystalball/seismology/v1/service_server';
