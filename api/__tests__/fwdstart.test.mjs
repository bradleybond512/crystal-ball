/**
 * fwdstart.js characterization tests
...
let handler;
try {
  handler = (await import('../fwdstart.js')).default
    ?? (await import('../fwdstart.js'));
} catch (err) {
  console.warn('Handler fwdstart.js failed to import:', err.message);
  handler = null;
}
