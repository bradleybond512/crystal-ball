...
All JSON API endpoints in CrystalBall **must** use sebuf. Do not create standalone `api/*.js` files — the legacy pattern is deprecated and being removed.
...
Create `proto/crystalball/seismology/v1/get_earthquake_details.proto`:

```protobuf
syntax = "proto3";
package crystalball.seismology.v1;

import "buf/validate/validate.proto";
import "crystalball/seismology/v1/earthquake.proto";
...
Edit `proto/crystalball/seismology/v1/service.proto`:

```protobuf
import "crystalball/seismology/v1/get_earthquake_details.proto";
...
Create `server/crystalball/seismology/v1/get-earthquake-details.ts`:
...
} from '../../../../src/generated/server/crystalball/seismology/v1/service_server';
...
Edit `server/crystalball/seismology/v1/handler.ts`:

```typescript
import type { SeismologyServiceHandler } from '../../../../src/generated/server/crystalball/seismology/v1/service_server';
...
```
proto/crystalball/sanctions/v1/
```

### 2. Define entity messages

Create `proto/crystalball/sanctions/v1/sanctions_entry.proto`:

```protobuf
syntax = "proto3";
package crystalball.sanctions.v1;
...
Create `proto/crystalball/sanctions/v1/list_sanctions.proto`:
...
import "buf/validate/validate.proto";
import "crystalball/core/v1/pagination.proto";
import "crystalball/sanctions/v1/sanctions_entry.proto";
...
message ListSanctionsRequest {
  ...
  crystalball.core.v1.PaginationRequest pagination = 3;
}
...
message ListSanctionsResponse {
  ...
  // Pagination metadata.
  crystalball.core.v1.PaginationResponse pagination = 2;
}
```

### 4. Define the service

Create `proto/crystalball/sanctions/v1/service.proto`:
...
import "sebuf/http/annotations.proto";
import "crystalball/sanctions/v1/list_sanctions.proto";
...
```
server/crystalball/sanctions/v1/
├── handler.ts # thin re-export
└── list-sanctions.ts # RPC implementation
```

`server/crystalball/sanctions/v1/list-sanctions.ts`:
...
} from '../../../../src/generated/server/crystalball/sanctions/v1/service_server';
...
`server/crystalball/sanctions/v1/handler.ts`:

```typescript
import type { SanctionsServiceHandler } from '../../../../src/generated/server/crystalball/sanctions/v1/service_server';
...
```typescript
import { createSanctionsServiceRoutes } from '../src/generated/server/crystalball/sanctions/v1/service_server';
import { sanctionsHandler } from './server/crystalball/sanctions/v1/handler';
...
} from '@/generated/client/crystalball/sanctions/v1/service_client';
...
| Type | Import | Use for |
|------|--------|---------|
| `GeoCoordinates` | `crystalball/core/v1/geo.proto` | Any lat/lon location (has built-in -90/90 and -180/180 bounds) |
| `BoundingBox` | `crystalball/core/v1/geo.proto` | Spatial filtering |
| `TimeRange` | `crystalball/core/v1/time.proto` | Time-based filtering (has `INT64_ENCODING_NUMBER`) |
| `PaginationRequest` | `crystalball/core/v1/pagination.proto` | Request pagination (has page_size 1-100 constraint) |
| `PaginationResponse` | `crystalball/core/v1/pagination.proto` | Response pagination metadata |
