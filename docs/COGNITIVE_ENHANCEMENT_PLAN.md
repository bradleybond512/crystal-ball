...
| 7 | Conformal Intervals | 🔲 | `claude/cognition-pr7-conformal` | needs PR 2 |
| 8 | Memory Consolidation | 🔲 | `claude/cognition-pr8-consolidation` | needs PR 1 |
| 9 | EVOI Collection Planner | 🔲 | `claude/cognition-pr9-evoi` | |
| 10 | Operator Forecast Journal | 🔲 | `claude/cognition-pr10-journal` | needs PR 2+4 |
