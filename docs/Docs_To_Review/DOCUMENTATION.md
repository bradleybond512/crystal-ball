...
🌐 **[Live Demo: crystalball.app](https://crystalball.app)** | 💻 **[Tech Variant: tech.crystalball.app](https://tech.crystalball.app)**
...
![Crystal Ball Dashboard](../new-crystal-ball.png)

## Platform Variants

Crystal Ball runs two specialized variants from a single codebase, each optimized for different monitoring needs:

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 Crystal Ball** | [crystalball.app](https://crystalball.app) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.crystalball.app](https://tech.crystalball.app) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
...
The tech variant ([tech.crystalball.app](https://tech.crystalball.app)) provides specialized layers for technology sector monitoring.
...
The Service Status panel tracks the operational health of external services that CrystalBall users may depend on.
...
// App.ts
const header = `Crystal Ball v${__APP_VERSION__}`;
```
...
- ✅ **Variant Switcher UI** - Compact orbital navigation between Crystal Ball and Tech Monitor
...
2. **Clone your fork** locally:
 ```bash
 git clone https://github.com/YOUR_USERNAME/crystalball.git
 cd crystalball
 ```
