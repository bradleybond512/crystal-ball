...
> Comprehensive reference for every external API consumed by Crystal Ball.
...
Crystal Ball integrates **38 distinct external API sources** (plus ~150 RSS feed
...
How Crystal Ball behaves when each external API is unavailable:
