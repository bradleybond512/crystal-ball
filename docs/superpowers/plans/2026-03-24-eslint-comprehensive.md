...
**Goal:** Add ESLint 9 with type-checked rules, unicorn, and sonarjs to Crystal Ball; fix all existing violations upfront so CI passes clean.
...
1. Go to `https://github.com/bradleybond512/crystal-ball/settings/branches`
