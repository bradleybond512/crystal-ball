...
**Goal:** Integrate FAA Aviation Weather Cameras into Crystal Ball as a panel, DeckGL map layer, disaster-mode tie-in, and AI-powered relevance/analysis feature.
