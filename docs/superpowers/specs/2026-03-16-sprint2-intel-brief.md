...
- **Key:** `crystalball-intel-brief-cache`
...
On first launch (no `crystalball-intel-brief-cache` in localStorage), the panel must not be blank. Behavior:
