...
export class EventHandlerManager implements AppModule {
 ...
 localStorage.setItem('crystalball-variant', variant);
 ...
 localStorage.setItem('crystalball-sidebar-collapsed', collapsed ? '1' : '0');
 ...
 if (localStorage.getItem('crystalball-sidebar-collapsed') === '1') {
 ...
 const mode = getMode();
 toolbarModeBtn.textContent = mode === 'ghost' ? '👻' : mode === 'gods-vision' ? '🌍' : '🔮';
 };
 updateModeBtn();
