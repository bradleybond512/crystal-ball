...
export function buildDesktopLayout(ctx: AppContext): string {
 ...
 <a class="mac-sidebar-footer-btn" href="https://crystal-ball-observatory.bradleybond512.chatgpt.site/" target="_blank" rel="noopener" title="Crystal Ball website" aria-label="Crystal Ball website">${icon('globe', { size: 16, label: 'Crystal Ball website' })}</a>
...
export function buildWebLayout(ctx: AppContext): string {
 ...
 <a href="https://crystal-ball-observatory.bradleybond512.chatgpt.site/" target="_blank" rel="noopener" class="github-link" title="Crystal Ball website">
 ${icon('globe', { size: 16, label: 'Crystal Ball website' })}
 </a>
