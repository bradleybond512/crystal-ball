...
import { CyberEspionagePanel } from '@/components/CyberEspionagePanel';import { SpaceWeaponizationPanel } from '@/components/SpaceWeaponizationPanel';
...
export class PanelLayoutManager implements AppModule {
 ...
 this.ctx.panels['arctic-competition'] = new ArcticCompetitionPanel();
    ...
    this.ctx.panels['cyber-espionage'] = new CyberEspionagePanel();    this.ctx.panels['space-weaponization'] = new SpaceWeaponizationPanel();
