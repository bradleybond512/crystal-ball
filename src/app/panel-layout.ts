...
import { RegimeStabilityPanel } from '@/components/RegimeStabilityPanel';import { CoerciveDiplomacyPanel } from '@/components/CoerciveDiplomacyPanel';
...
export class PanelLayoutManager implements AppModule {
 ...
 this.ctx.panels['territorial-disputes'] = new TerritorialDisputesPanel(); this.ctx.panels['regime-stability'] = new RegimeStabilityPanel(); this.ctx.panels['coercive-diplomacy'] = new CoerciveDiplomacyPanel();
