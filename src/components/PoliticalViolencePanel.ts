/**
 * PoliticalViolencePanel Ñ ACLED-inspired global political violence tracker.
 *
 * Displays: Global Violence Index header á Hotspot table sorted by monthly
 * events á Recent event log sorted by significance. Clicking a hotspot row
      ...
      <div class="pv-event-row ${eventTypeClass(e.eventType)}"
        ...
        <div style="display:flex;align-items:center;gap:8px;margin-top:4px;">
          <span style="font-size:var(--text-2xs);color:#888;">
            ${e.fatalities > 0 ? `${e.fatalities.toLocaleString()} fatalities á` : ''} Actor: ${escapeHtml(e.actor)}
          </span>
