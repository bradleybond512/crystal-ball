  ...
  private buildTable(rows: CountryRenderData[]): string {
    ...
    const header = `
      <tr style="border-bottom:1px solid var(--border-subtle,#333);text-align:left;">
        <th style="${thStyle}" data-scp-sort="fragility" scope="col">Country${sortArrow('fragility')}</th>
        <th style="${thStyle};text-align:center;" data-scp-sort="fragility" scope="col">Fragility${sortArrow('fragility')}</th>
        <th style="${thStyle};text-align:center;" data-scp-sort="governance" scope="col">Gov${sortArrow('governance')}</th>
        <th style="${thStyle};text-align:center;" data-scp-sort="ruleOfLaw" scope="col">RoL${sortArrow('ruleOfLaw')}</th>
        <th style="${thStyle};text-align:center;" data-scp-sort="serviceDelivery" scope="col">SvD${sortArrow('serviceDelivery')}</th>
        <th style="${thStyle};text-align:center;" data-scp-sort="resilience" scope="col">Res${sortArrow('resilience')}</th>
