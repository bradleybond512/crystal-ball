...
export class SurvivalGuidePanel extends Panel {
  ...
  private renderDetail(id: GuideId): string {
    ...
    const mistakes = `
      <div style="margin:14px 0;padding:10px 12px;border:1px solid var(--sev-critical,#ff453a);border-radius:8px;background:var(--sev-critical-muted,rgba(255,69,58,0.08));">
