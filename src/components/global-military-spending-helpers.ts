...
const COUNTRIES: CountrySpending[] = [
  ...
  {
    id: 'C005', country: 'Saudi Arabia', region: 'Middle East', budgetBn: 80, gdpPercent: 6.0,
    yoyChangePct: 4, trend: 'increasing',
  ...
  {
    id: 'C011', country: 'Ukraine', region: 'East Europe', budgetBn: 64, gdpPercent: 34.0,
  ...
  {
    id: 'C013', country: 'Poland', region: 'Europe', budgetBn: 35, gdpPercent: 4.0,
  ...
  {
    id: 'C015', country: 'Australia', region: 'Asia-Pacific', budgetBn: 40, gdpPercent: 2.0,
    yoyChangePct: 11, trend: 'increasing',
...
export function getTopSpenders(countries: CountrySpending[], n: number = 5): CountrySpending[] {
  return [...countries].sort((a, b) => b.budgetBn - a.budgetBn).slice(0, n);
}

export function getRearmingCountries(countries: CountrySpending[], thresholdPct: number = 10): CountrySpending[] {
