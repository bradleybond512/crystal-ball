// gray-zone-conflict-helpers.ts Ñ pure deterministic helpers
...
const MOCK_OPERATIONS: GrayZoneOperation[] = [
  ...
  { id: 'ru-baltics-pressure', name: 'Russia Baltic Hybrid Pressure', actor: 'Russia', targetNation: 'Baltic States', tactics: ['disinformation','cyber-harassment','economic-coercion','election-interference'], domain: 'information', startDate: '2022-01-01', active: true, intensity: 'moderate', escalationPotential: 55, deniabilityScore: 65, responseConstraint: 'NATO Article 5 gap at sub-threshold Ñ proving attribution' },
...
export function scoreOperationSeverity(op: GrayZoneOperation): number {
  ...
  return Math.min(100, Math.round(intensityMap[op.intensity] + tacticBonus + deniabilityWeight + op.escalationPotential * 0.0));
}
