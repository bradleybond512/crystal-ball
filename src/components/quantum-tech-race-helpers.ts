...
const MOCK_PROGRAMS: QuantumProgram[] = [
  { country: 'USA', domain: 'computing', maturity: 'advanced-prototype', qubitCount: 1121, annualInvestmentUSD: 3_200_000_000, militaryApplication: true, threatToEncryption: 45, leadingInstitutions: ['IBM', 'Google', 'NIST', 'DARPA'], dominanceScore: 88 },
  { country: 'China', domain: 'computing', maturity: 'advanced-prototype', qubitCount: 504, annualInvestmentUSD: 15_000_000_000, militaryApplication: true, threatToEncryption: 35, leadingInstitutions: ['USTC', 'Baidu', 'Alibaba Quantum Lab'], dominanceScore: 82 },
  { country: 'China', domain: 'communications', maturity: 'operational', annualInvestmentUSD: 2_000_000_000, militaryApplication: true, threatToEncryption: 0, leadingInstitutions: ['USTC', 'QuantumCTek'], dominanceScore: 95 },
  { country: 'USA', domain: 'cryptography', maturity: 'operational', annualInvestmentUSD: 800_000_000, militaryApplication: true, threatToEncryption: 0, leadingInstitutions: ['NIST', 'NSA'], dominanceScore: 90 },
  { country: 'EU', domain: 'computing', maturity: 'early-prototype', qubitCount: 127, annualInvestmentUSD: 1_200_000_000, militaryApplication: false, threatToEncryption: 15, leadingInstitutions: ['IQM', 'Pasqal', 'QuTech'], dominanceScore: 65 },
  { country: 'Russia', domain: 'sensing', maturity: 'experimental', annualInvestmentUSD: 500_000_000, militaryApplication: true, threatToEncryption: 0, leadingInstitutions: ['Rosatom', 'Moscow State University'], dominanceScore: 55 },
  { country: 'UK', domain: 'computing', maturity: 'early-prototype', qubitCount: 56, annualInvestmentUSD: 700_000_000, militaryApplication: false, threatToEncryption: 10, leadingInstitutions: ['Oxford', 'Cambridge', 'Riverlane'], dominanceScore: 60 },
  { country: 'Japan', domain: 'computing', maturity: 'advanced-prototype', qubitCount: 64, annualInvestmentUSD: 900_000_000, militaryApplication: false, threatToEncryption: 12, leadingInstitutions: ['Fujitsu', 'IBM Japan', 'RIKEN'], dominanceScore: 62 },
];
