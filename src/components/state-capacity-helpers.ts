...
export const COUNTRY_DATA = new Map<string, CountryCapacityData>([
  ['SYR', {
    countryCode: 'SYR',
    countryName: 'Syria',
    region: 'Middle East',
    governmentEffectiveness: 1.2,
    bureaucraticQuality: 1,
    ruleOfLaw: 0.8,
...
export function classifyCapacityTier(score: number): CapacityTier {
  if (score >= 8) return 'collapsed';
  if (score >= 6) return 'fragile';
