...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'cyber-espionage': { name: 'Cyber Espionage Tracker', enabled: true, priority: 1 },  'strategic-deception': { name: 'Strategic Deception Tracker', enabled: true, priority: 1 },
