...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'cyber-espionage': { name: 'Cyber Espionage Tracker', enabled: true, priority: 1 },  'digital-autocracy': { name: 'Digital Autocracy', enabled: true, priority: 1 },
