...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'cyber-espionage': { name: 'Cyber Espionage Tracker', enabled: true, priority: 1 },  'space-weaponization': { name: 'Space Weaponization Tracker', enabled: true, priority: 1 },
