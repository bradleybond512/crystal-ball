...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'saved-places-filter': { name: 'Saved Places Filter', enabled: true, priority: 1 },
  'watchlist-locations': { name: 'Watched Locations', enabled: true, priority: 1 },
  'watch-area-alerting': { name: 'Watch Area Alerting', enabled: true, priority: 1 },
  ...
  'alert-deduplication': { name: 'Alert Deduplication', enabled: true, priority: 2 },
  ...
  'trade-route-risk-scorer': { name: 'Trade Route Risk Scorer', enabled: true, priority: 1 },
  ...
  'little-snitch': { name: 'Little Snitch Outbound', enabled: true, priority: 2 },
  ...
  'evidence-chain-builder': { name: 'Evidence Chain Builder', enabled: true, priority: 2 },
  'entity-registry': { name: 'Entity Registry', enabled: true, priority: 1 },
  ...
  'notification-audit': { name: 'Notification Audit', enabled: true, priority: 2 },
  'notification-provenance': { name: 'Notification Provenance', enabled: true, priority: 2 },
  'trust-budget': { name: 'Trust Budget', enabled: true, priority: 2 },
  'intelligence-trust-budget': { name: 'Intelligence Trust Budget', enabled: true, priority: 2 },
  'notification-settings': { name: 'Notification Settings', enabled: true, priority: 1 },
  'notification-preferences': { name: 'Notification Preferences', enabled: true, priority: 1 },
  ...
  'feed-watchdog': { name: 'Feed Watchdog', enabled: true, priority: 2 },
  'source-credibility-tracker': { name: 'Source Credibility Tracker', enabled: true, priority: 2 },
  'system-diagnostic': { name: 'System Diagnostic', enabled: true, priority: 1 },
  'assumption-tracker': { name: 'Assumption Audit', enabled: true, priority: 2 },
  'assumption-tracker-v2': { name: 'Assumption Tracker', enabled: true, priority: 2 },
  'domain-scorecard': { name: 'Domain Scorecards', enabled: true, priority: 2 },
  'behavioral-response': { name: 'Behavioral Response', enabled: true, priority: 1 },
  'causal-chain': { name: 'Causal Chains', enabled: true, priority: 1 },
  'civilization-pulse': { name: 'Civilization Pulse', enabled: true, priority: 1 },
  'alert-escalation': { name: 'Alert Escalation', enabled: true, priority: 1 },
  'mission-control-dashboard': { name: 'Mission Control', enabled: true, priority: 1 },
  'compound-event-detector': { name: 'Compound Events', enabled: true, priority: 1 },
  'world-narrative': { name: 'World Narrative', enabled: true, priority: 1 },
  'quality-debt': { name: 'Quality Debt', enabled: true, priority: 2 },
  'failure-prediction': { name: 'Failure Prediction', enabled: true, priority: 1 },
  'operational-playbook': { name: 'Operational Playbooks', enabled: true, priority: 1 },
  'self-test': { name: 'Self-Test', enabled: true, priority: 2 },
  'self-test-runner': { name: 'Self-Test Runner', enabled: true, priority: 2 },
  'operator-mode': { name: 'Operator Mode', enabled: true, priority: 2 },
  'operator-shift-report': { name: 'Operator Shift Report', enabled: true, priority: 2 },
  'command-center': { name: 'Command Center', enabled: true, priority: 1 },
  'competitive-hypothesis': { name: 'Competing Hypotheses', enabled: true, priority: 1 },
  'competitive-hypothesis-engine': { name: 'Competing Hypotheses (Engine)', enabled: true, priority: 2 },
  'meta-confidence': { name: 'Meta-Confidence', enabled: true, priority: 2 },
  'meta-confidence-calibration': { name: 'Meta-Confidence Calibration', enabled: true, priority: 2 },
  ...
  'crisis-trajectory': { name: 'Crisis Trajectory', enabled: true, priority: 1 },
  'regional-resilience': { name: 'Regional Resilience', enabled: true, priority: 2 },
  'intelligence-digest': { name: 'Intelligence Digest', enabled: true, priority: 1 },
  'active-learning': { name: 'Active Learning', enabled: true, priority: 2 },
  'active-learning-queue': { name: 'Active Learning Queue', enabled: true, priority: 2 },
  ...
  'recovery-modeling': { name: 'Recovery Modeling', enabled: true, priority: 2 },
  'algo-eval': { name: 'Algorithm Evaluation', enabled: true, priority: 3 },
  'backtest': { name: 'Backtest Gate', enabled: true, priority: 3 },
  'backtest-gate': { name: 'Backtest Gate (pre-apply)', enabled: true, priority: 3 },
  'global-rhythm': { name: 'Global Rhythm', enabled: true, priority: 2 },
  'temporal-anomaly-detector': { name: 'Temporal Anomaly Detector', enabled: true, priority: 2 },
  'threat-horizon': { name: 'Threat Horizon', enabled: true, priority: 1 },
  ...
  'safety-case-dashboard': { name: 'Safety Case Dashboard', enabled: true, priority: 1 },
  'experiment-manager': { name: 'Experiments', enabled: true, priority: 2 },
  'domain-scorecards': { name: 'Domain Scorecards', enabled: true, priority: 2 },
  'geopolitical-event-calendar': { name: 'Event Calendar', enabled: true, priority: 2 },
  'signal-enrichment': { name: 'Signal Enrichment', enabled: true, priority: 2 },
  'threat-correlation-matrix': { name: 'Correlation Matrix', enabled: true, priority: 2 },
  'geospatial-clustering': { name: 'Geo Clusters', enabled: true, priority: 2 },
  'intelligence-briefing-export': { name: 'Briefing Export', enabled: true, priority: 2 },
  'intelligence-index': { name: 'Intel Index', enabled: true, priority: 1 },
  'domain-dependency': { name: 'Domain Dependency', enabled: true, priority: 2 },
  'situation-timeline': { name: 'Situation Timeline', enabled: true, priority: 2 },
  ...
  'counterfactual-reasoning': { name: 'Counterfactual Reasoning', enabled: true, priority: 2 },
  'situation-priority-queue': { name: 'Situation Priority Queue', enabled: true, priority: 2 },
  'intelligence-health-monitor': { name: 'Intelligence Health Monitor', enabled: true, priority: 1 },
  'intelligence-loop-orchestrator': { name: 'Intelligence Loop Orchestrator', enabled: true, priority: 1 },
  'analyst-notebook': { name: 'Analyst Notebook', enabled: true, priority: 2 },
  'persistent-query-engine': { name: 'Persistent Query Engine', enabled: true, priority: 2 },
  'alert-trace': { name: 'Alert Trace', enabled: true, priority: 2 },
  'alert-explanation': { name: 'Alert Explanation', enabled: true, priority: 2 },
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
 ...
 panelKeys: ['threat-dashboard', 'command-center', 'competitive-hypothesis', 'competitive-hypothesis-engine', 'meta-confidence', 'meta-confidence-calibration', 'system-diagnostic', 'assumption-tracker', 'assumption-tracker-v2', 'counterfactual', 'causal-chain', 'domain-scorecard', 'behavioral-response', 'world-narrative', 'civilization-pulse', 'compound-event-detector', 'mission-control-dashboard', 'alert-escalation', 'quality-debt', 'operational-playbook', 'failure-prediction', 'self-test', 'self-test-runner', 'operator-mode', 'operator-shift-report', 'intelligence-feed', 'intelligence-timeline', 'algorithm-diagnostic', 'outcome-ledger', 'active-learning', 'active-learning-queue', 'improvement-scheduler', 'model-governance', 'recovery-modeling', 'bias-detection', 'contradiction-detector', 'crisis-trajectory', 'intelligence-digest', 'regional-resilience', 'algo-eval', 'backtest', 'backtest-gate', 'global-rhythm', 'temporal-anomaly-detector', 'threat-horizon', 'shadow-mode', 'shadow-comparison', 'cognitive-bias-detector', 'crisis-signature', 'collection-gap', 'safety-case', 'safety-case-dashboard', 'experiment-manager', 'domain-scorecards', 'geopolitical-event-calendar', 'signal-enrichment', 'threat-correlation-matrix', 'geospatial-clustering', 'intelligence-briefing-export', 'intelligence-index', 'situation-timeline', 'domain-dependency', 'multi-agent-review', 'repair-recommendations', 'mission-ledger-bridge', 'counterfactual-replay', 'counterfactual-reasoning', 'situation-priority-queue', 'intelligence-health-monitor', 'intelligence-loop-orchestrator', 'analyst-notebook', 'persistent-query-engine', 'evidence-graph', 'evidence-chain-builder', 'entity-registry', 'alert-trace', 'alert-explanation', 'scenario-replay', 'playbook', 'aviation-intel', 'shortage-radar', 'shortage-detail-wheat', 'shortage-detail-corn', 'shortage-detail-rice', 'shortage-detail-soybeans', 'shortage-detail-diesel', 'shortage-detail-gasoline', 'shortage-detail-natural-gas', 'shortage-detail-jet-fuel', 'maritime-intel', 'trade-route-risk-scorer', 'supply-chain-disruption', 'watchlist', 'saved-places', 'saved-places-filter', 'watchlist-locations', 'watch-area-alerting', 'local-logistics', 'comms-plan', 'unified-alert-inbox', 'alert-rules', 'alert-deduplication', 'situation-awareness', 'alert-center', 'strategic-risk', 'cii', 'geo-hubs', 'intel', 'gdelt-intel', 'cascade', 'telegram-intel', 'intelligence-briefing', 'ask-crystal-ball', 'survival-advisor', 'threat-synthesis', 'scenario-simulator', 'escalation-forecast', 'synthesis', 'cyber-geo', 'economic-intel', 'notification-digest', 'notification-settings', 'notification-preferences', 'notification-history', 'notification-audit', 'notification-provenance', 'trust-budget', 'intelligence-trust-budget', 'personal-relevance', 'pattern-of-life', 'course-of-action', 'kill-chain', 'orbat', 'after-action-review', 'entity-link-graph', 'timeline-scrubber', 'intel-report', 'compound-threat', 'correlation-matrix', 'correlation-map', 'mediastack-news', 'situations', 'observation-rules', 'what-changed', 'strike-package', 'strike-packages', 'api-diagnostic', 'cascade-simulator', 'feed-health', 'feed-watchdog', 'source-credibility-tracker', 'dod-news', 'nato-news', 'foreign-mil-news', 'isw-reports', 'reliefweb-crises', 'bellingcat-osint', 'acaps-crises', 'liveuamap', 'un-security-council', 'combatant-commands', 'congress-defense', 'gov-warning-convergence', 'dsca-arms-transfers', 'dod-contracts', 'wikidata-bases', 'opensanctions', 'sanctions-intel', 'infra-risk-matrix', 'earthquake-super', 'sms-command-interface'],
 variants: ['full'],
  },
  regionalNews: {
