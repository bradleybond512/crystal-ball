...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'cyber-espionage': { name: 'Cyber Espionage Tracker', enabled: true, priority: 1 },  'economic-espionage': { name: 'Economic Espionage Tracker', enabled: true, priority: 1 },
