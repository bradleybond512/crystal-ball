...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'regime-stability': { name: 'Regime Stability', enabled: true, priority: 1 },  'coercive-diplomacy': { name: 'Coercive Diplomacy', enabled: true, priority: 1 },
};
