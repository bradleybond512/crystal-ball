...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
 ...
 apiHandlers: ['server/crystalball/conflict/v1/handler.ts', 'server/crystalball/infrastructure/v1/handler.ts', 'server/crystalball/cyber/v1/handler.ts', 'server/crystalball/maritime/v1/handler.ts', 'server/crystalball/military/v1/handler.ts'],
 locality: 'api-key',
 ...
 apiHandlers: ['server/crystalball/news/v1/handler.ts'],
 locality: 'api-key',
 ...
 apiHandlers: ['server/crystalball/market/v1/handler.ts'],
 locality: 'fully-local',
 ...
 apiHandlers: ['server/crystalball/military/v1/handler.ts'],
 locality: 'api-key',
