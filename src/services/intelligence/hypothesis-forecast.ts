...
// eslint-disable-next-line sonarjs/deprecation -- getBoostMultiplier is the documented legacy path retained alongside getRecalibrator (PR 2)
...
export function forecastHypothesis(
  ...
  // eslint-disable-next-line sonarjs/deprecation -- legacy multiplier intentionally retained; recalibrator below is the primary path
