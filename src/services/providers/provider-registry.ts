...
export const PROVIDER_DEFINITIONS: readonly ProviderDefinition[] = [
  ...
  { id: 'openaq-v3', domain: 'air_quality', displayName: 'OpenAQ v3', authType: 'free_key', requiredSecret: 'OPENAQ_API_KEY', baseUrl: 'https://api.openaq.org', rateLimitNote: 'keyed, per-plan limits', freshnessTtlMs: 2 * HOUR, reliabilityWeight: 0.85, fallbackPriority: 2, independenceGroup: 'openaq' },
