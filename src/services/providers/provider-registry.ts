...
export const PROVIDER_DEFINITIONS: readonly ProviderDefinition[] = [
  ...
  { id: 'adsbexchange', domain: 'adsb', displayName: 'ADSBExchange', authType: 'free_key', requiredSecret: 'WINGBITS_API_KEY', baseUrl: 'https://adsbexchange.com', rateLimitNote: 'keyed, per-plan limits', freshnessTtlMs: 2 * MIN, reliabilityWeight: 0.85, fallbackPriority: 1, independenceGroup: 'adsbx' },
  ...
  { id: 'space-track', domain: 'space', displayName: 'Space-Track', authType: 'account', requiredSecret: 'NASA_API_KEY', baseUrl: 'https://www.space-track.org', rateLimitNote: '30 req/min, 300/hour', freshnessTtlMs: 12 * HOUR, reliabilityWeight: 0.9, fallbackPriority: 2, independenceGroup: 'us-gov-space' },
