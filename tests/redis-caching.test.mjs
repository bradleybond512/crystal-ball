...
describe('theater posture caching behavior', { concurrency: 1 }, () => {
 ...
 return importPatchedTsModule('server/crystalball/military/v1/get-theater-posture.ts', {
 './_shared': resolve(root, 'server/crystalball/military/v1/_shared.ts'),
...
describe('country intel brief caching behavior', { concurrency: 1 }, () => {
 ...
 return importPatchedTsModule('server/crystalball/intelligence/v1/get-country-intel-brief.ts', {
...
describe('military flights bbox behavior', { concurrency: 1 }, () => {
 ...
 return importPatchedTsModule('server/crystalball/military/v1/list-military-flights.ts', {
 './_shared': resolve(root, 'server/crystalball/military/v1/_shared.ts'),
 '../../../_shared/constants': resolve(root, 'server/_shared/constants.ts'),
 '../../../_shared/redis': resolve(root, 'server/_shared/redis.ts'),
